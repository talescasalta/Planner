...
- O Dependency Review bloqueia novas vulnerabilidades altas/críticas em dependências de desenvolvimento e runtime. CodeQL analisa JavaScript/TypeScript em PRs, `main` e agenda semanal. Scorecard publica SARIF semanalmente como informação, sem requisito agregado de merge.
