	...
	>
		...
		<div class="grid grid-cols-1 md:grid-cols-4 gap-3">
			<div class="md:col-span-2">
				<label
					for="rule-pattern"
					class="block text-xs font-medium text-gray-700">Padrão</label
				>
				<input
					id="rule-pattern"
					name="pattern"
			...
			<div>
				<label
					for="rule-confidence"
					class="block text-xs font-medium text-gray-700">Confiança</label
				>
				<input
					id="rule-confidence"
					name="confidence"
		...
		<div class="grid grid-cols-1 md:grid-cols-3 gap-3">
			<div>
				...
				>
					...
					{#each parentCategories as c (c.id)}
			...
			<div>
				<label
					for="rule-profile"
					class="block text-xs font-medium text-gray-700">Atribuir a</label
				>
				<select
					id="rule-profile"
