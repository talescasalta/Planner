...
<div class="min-h-screen flex items-center justify-center bg-gray-50 px-4">
	<div class="w-full max-w-sm space-y-6">
		<div class="space-y-2 text-center">
			<h1 class="text-2xl font-semibold text-gray-900">Criar nova senha</h1>
			<p class="text-sm text-gray-600">Escolha uma nova senha para sua conta.</p>
		</div>
		...
		{#if form?.success}
			<div class="text-center">
				<a href="/login" class="text-sm text-indigo-600 hover:text-indigo-800 font-medium">Ir para login</a>
			</div>
		{/if}
	</div>
</div>
